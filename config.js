...
export const siteConfig = 
{
    ...
    heroSlides: [
        ...
        },
        {
            ...
            desc: "Pouring great pints, serving outstanding food, and maintaining the warmest hearth in North Ayrshire."
        },
        {
        ...
        ,
        {
            imgUrl: "./images/QuizNight_ThreeReasons.jpg",
            title: "Quiz Night every Monday night",
            desc: "The free Quiz starts at 9pm. You get a lovely free buffet at half time, and the winning prize is £20 voucher"
        }
    ],
    homePage: {
        ...
        highlights: [
            ...
            { icon: "users", title: "Family Tradition", desc: "Proudly independent hospitality passed down through the family, maintaining a high standard for locals and visitors alike." },
            { icon: "beer", title: "Premium Gantry", desc: "A wide selection of rotating real ales, crisp cold lagers, artisan Scottish gins, and exceptional malt whiskies." },
        ...
        googleReviews: [
            { initials: "AM", name: "Andrew M.", "badge": "Local Guide", text: "\"The exceptional meals here never disappoint. The steak pie is legendary, the pastry is light, and the service is fast and friendly even when they are packed on a busy Sunday.\"" },
            { initials: "HC", name: "Helen C.", "badge": "Family Diner", text: "\"Brought the family in for their traditional Sunday roast and it was easily the best we've had in Ayrshire. Massive Yorkshire puddings and the beef melted in your mouth.\"" },
            { initials: "GR", name: "Graham R.", "badge": "Regular", text: "\"A proper pub with restaurant-standard food. Stewart and the team run a brilliant establishment here—carrying on a fantastic local tradition.\"" }
        ]
    },
    aboutPage: {
        title: "Our Story",
        subtitle: "Established in 2014, our tavern represents a proud family legacy of coastal hospitality, great company, and exceptional cooking...",
        storyParagraphs: [
            ...
            "Today, the venue is solely run by owner Stewart Grant, who proudly follows in the footsteps of his father, Colin. Carrying forward decades of family insight, standards, and dedication, Stewart has cemented the pub's reputation as a must-visit destination on the Largs front.",
            "We believe that a great pub relies on consistency: local ingredients handled with care, a comforting hearth, and an unyielding commitment to making every single day-tripper and local resident feel instantly at home.",
        ...
        features: [
            { emoji: "🥩", title: "Exceptional Dining", desc: "A diverse, non-seafood menu highlighting premium beef burgers, homemade traditional pies, and excellent vegetarian alternatives." },
    ...
    contactPage: {
        ...
        googlePlaceId: "ChIJu-exampleID_ThreeReasonsLargs", 
